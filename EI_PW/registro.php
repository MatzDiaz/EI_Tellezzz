...
<body class="body">
  ...
  <main class="main">
    <div class="container mt-4 w-50" >
      <form name="frm" id="frm" method="POST" action="ingreso.php">
        ...
        <div class="mb-3">
          ...
          <p class="alert alert-danger" id="app" style="display: block;">Ingresa el apellido válido!!</p>
        </div>
        ...
        <div class="mb-3">
          ...
          <p class="alert alert-danger" id="tel" style="display: block;">Ingresa el número de teléfono válido!!</p>
        </div>

        <!-- Email -->
        <div class="mb-3">
          <label for="email" class="form-label">E-mail:</label>
          <input type="text" name="email" id="email" class="form-control" onchange="validarEmail()">
          <p class="alert alert-danger" id="mail" style="display: block;">Ingresa el correo válido!!</p>
        </div>

        <!-- Contra -->
        <div class="mb-3">
          <label for="contrasena" class="form-label">Contraseña:</label>
          <input type="text" name="contrasena" id="contrasena" class="form-control" onchange="">
          <p class="alert alert-danger" id="contra" style="display: block;">Ingresa la contraseña!!</p>
        </div>
